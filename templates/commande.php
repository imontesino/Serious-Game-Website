...
$requete = $bdd->prepare("insert into commande(code_cmd,code_clt,code_resp,code_prd,date_livraison) values(?,?,?,?,?)");
$requete->execute(array($_POST['code_cmd'],$_POST['code_clt'],$_POST['code_resp'],$_POST['code_prd'],$_POST['date_livraison']));
?>

 <br><br><br><br><a href="commande.html"> Retour a la page precedante<a> <br><br><br><br>
  </body>
